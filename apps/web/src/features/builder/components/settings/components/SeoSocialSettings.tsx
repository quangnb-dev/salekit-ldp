  ...
  return (
    <>
      <div className="space-y-4">
        <div>
          <p className="mb-1 text-sm font-medium text-slate-700">Tiêu đề</p>
          <Input
            type="text"
            value={settings.seoTitle}
            onChange={(event) => setSetting("seoTitle", event.target.value)}
            placeholder="Ví dụ: Trang đăng nhập mẫu"
          />
        </div>
        ...
        <div>
          <p className="mb-1 text-sm font-medium text-slate-700">Từ khóa</p>
          <Input
            type="text"
            value={settings.seoKeywords}
            onChange={(event) => setSetting("seoKeywords", event.target.value)}
            placeholder="Nhập từ khóa về trang, ví dụ: salepage, salekit..."
          />
        </div>
        ...
        <div>
          <p className="mb-1 text-sm font-medium text-slate-700">Favicon</p>
